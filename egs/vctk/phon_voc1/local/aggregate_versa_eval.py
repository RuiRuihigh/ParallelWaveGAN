...
# Copied with minimal changes from ESPnet's
# egs2/TEMPLATE/asr1/pyscripts/utils/aggregate_eval.py (Copyright 2024
# Jiatong Shi, Apache 2.0) -- it's self-contained (no espnet2 imports), so we
# keep a local copy here instead of depending on the espnet checkout path.

"""Aggregate VERSA per-shard scoring results into averaged metrics."""
